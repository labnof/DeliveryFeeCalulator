//  TextFormField validators functions.
String? numTextValidator(value) {
  try {
...
String? itemTextValidator(value) {
  try {
...
bool isDateRegex(String string) {
...
bool isTimeRegex(String string) {
